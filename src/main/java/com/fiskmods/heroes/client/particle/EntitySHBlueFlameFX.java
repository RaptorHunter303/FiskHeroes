...
public class EntitySHBlueFlameFX extends EntitySHFX
{
    private float flameScale;

    public EntitySHBlueFlameFX(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
    {
        ...
        particleMaxAge = (int) (5.0D / (Math.random() * 0.25D + 0.75D));
        noClip = false;
