...
public class EntitySHRepulsorBlastFX extends EntitySHFX
{
    private float flameScale;

    public EntitySHRepulsorBlastFX(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
    {
