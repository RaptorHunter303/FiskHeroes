...
public class RenderCactusSpike extends Render
{
    private final ResourceLocation texture = new ResourceLocation(FiskHeroes.MODID, "textures/blocks/cactus_spike.png");
    private final ModelSpike spike = new ModelSpike(0.085F, 0.8F, 0.125F);

    public void renderSpike(EntityCactusSpike entity, double x, double y, double z, float f, float partialTicks)
    {
        GL11.glPushMatrix();
    ...
    {
        renderSpike((EntityCactusSpike) entity, x, y, z, f, partialTicks);
    }
