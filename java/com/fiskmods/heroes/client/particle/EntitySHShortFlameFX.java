...
public class EntitySHShortFlameFX extends EntityFX
{
    private float flameScale;

    public EntitySHShortFlameFX(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
    {
        ...
        particleMaxAge = (int) (2.0D / (Math.random() * 0.8D + 0.2D)) + 2;
        noClip = false;
    ...
    public void renderParticle(Tessellator tessellator, float partialTicks, float f, float f1, float f2, float f3, float f4)
    {
        ...
        super.renderParticle(tessellator, partialTicks, f, f1, f2, f3, f4);
    }
